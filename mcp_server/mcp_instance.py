...
from tools.clinical_distill_tool import extract_clinical_symptoms, check_clinical_urgency
...
mcp.tool(name="ExtractClinicalSymptoms", description="Extracts structured symptoms, duration, severity and urgency from unstructured clinical notes or patient descriptions.")(extract_clinical_symptoms)
mcp.tool(name="CheckClinicalUrgency", description="Quickly assesses whether a clinical note describes an urgent medical situation requiring immediate attention.")(check_clinical_urgency)
